...
namespace POS_System_BAL.Services.Goods
{
    public class GoodsServices : IGoodsServices
    {
        ...
        private readonly IGenericRepository<TblGoodsunit> _genericRepository;
        private readonly IMapper _mapper;

        public GoodsServices( IGoodsRepository goodsRepository, IMapper mapper ,IGenericRepository<TblGoodsunit> genericRepository)
        {
        ...
        public async Task<TblGoodsunit> SaveUnit(TblGoodsunit tblGoodsunit)
        {
            await _genericRepository.AddAsync(tblGoodsunit);
            return tblGoodsunit;
        }
