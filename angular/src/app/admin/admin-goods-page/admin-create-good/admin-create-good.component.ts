...
@Component({
  selector: 'app-admin-create-good',
  templateUrl: './admin-create-good.component.html',
  styleUrl: './admin-create-good.component.scss'
})
export class AdminCreateGoodComponent implements OnInit {
  ...
  form: FormGroup;
    ...
    constructor(
      public dialogRef: MatDialogRef<AdminCreateGoodComponent>,
