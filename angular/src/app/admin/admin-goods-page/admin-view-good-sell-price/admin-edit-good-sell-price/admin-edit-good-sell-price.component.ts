...
@Component({
  selector: 'app-admin-edit-good-sell-price',
  templateUrl: './admin-edit-good-sell-price.component.html',
  styleUrl: './admin-edit-good-sell-price.component.scss'
})
export class AdminEditGoodSellPriceComponent implements OnInit{
  ...
  form: FormGroup;
    ...
    constructor(
      private dialogRef: MatDialogRef<AdminEditGoodSellPriceComponent>,
    ...
    buildForm(){
      this.form = this.fb.group({
        ...
        barcode: [this.data.sellPrice?.barcode],
