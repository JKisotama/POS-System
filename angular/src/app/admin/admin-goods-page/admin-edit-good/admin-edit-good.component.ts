...
@Component({
  selector: 'app-admin-edit-good',
  templateUrl: './admin-edit-good.component.html',
  styleUrl: './admin-edit-good.component.scss'
})
export class AdminEditGoodComponent implements OnInit {
  ...
  form: FormGroup;
    ...
    constructor(
      public dialogRef: MatDialogRef<AdminEditGoodComponent>,
