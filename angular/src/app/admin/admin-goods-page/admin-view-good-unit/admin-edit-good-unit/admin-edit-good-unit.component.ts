...
@Component({
  selector: 'app-admin-edit-good-unit',
  templateUrl: './admin-edit-good-unit.component.html',
  styleUrl: './admin-edit-good-unit.component.scss'
})
export class AdminEditGoodUnitComponent implements OnInit{

  form: FormGroup;
    storeId: string | null = null;
  
    constructor(
      public dialogRef: MatDialogRef<AdminEditGoodUnitComponent>,
