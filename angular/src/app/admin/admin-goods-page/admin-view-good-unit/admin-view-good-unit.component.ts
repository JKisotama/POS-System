...
import { AdminCreateGoodUnitComponent } from './admin-create-good-unit/admin-create-good-unit.component';
import { AdminEditGoodUnitComponent } from './admin-edit-good-unit/admin-edit-good-unit.component';
import { ConfirmDialogComponent } from '../../../confirm-dialog.component';

@Component({
  selector: 'app-admin-view-good-unit',
  templateUrl: './admin-view-good-unit.component.html',
  styleUrl: './admin-view-good-unit.component.scss'
})
export class AdminViewGoodUnitComponent implements OnInit{
  ...
  form: FormGroup;
    ...
    openCreateGoodUnit(goodsId: string): void {
      const dialogRef = this.dialog.open(AdminCreateGoodUnitComponent, {
        width: '700px',
    ...
    openEditGoodUnit(goodsUnit: GoodsUnitDTO): void {
      const dialogRef = this.dialog.open(AdminEditGoodUnitComponent, {
        width: '700px',
        panelClass: 'custom-dialog-container',
        data: { goodsUnit }
      });
