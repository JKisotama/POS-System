...
@Component({
  selector: 'app-admin-create-good-unit',
  templateUrl: './admin-create-good-unit.component.html',
  styleUrl: './admin-create-good-unit.component.scss'
})
export class AdminCreateGoodUnitComponent implements OnInit{
  ...
  form: FormGroup;
    ...
    constructor(
      public dialogRef: MatDialogRef<AdminCreateGoodUnitComponent>,
    ...
    Save(){
      if(this.form.valid){
        ...
        (error) => {
          console.error('Error creating Good unit for Good:', error);
