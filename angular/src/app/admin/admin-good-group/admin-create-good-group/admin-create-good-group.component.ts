...
@Component({
  selector: 'app-admin-create-good-group',
  templateUrl: './admin-create-good-group.component.html',
  styleUrl: './admin-create-good-group.component.scss'
})
export class AdminCreateGoodGroupComponent {
  ...
  form: FormGroup;
    ...
    constructor(
      public dialogRef: MatDialogRef<AdminCreateGoodGroupComponent>,
